...
class XCZTaskDetailFinishedCell: UITableViewCell {
    ...
    private func p_setUpView() {
        ...
        completeTitleLabel.text = "完成日期"
        completeTitleLabel.textColor = cellTitleColor
        completeTitleLabel.font = cellTextFont
        bubbleImageView.addSubview(completeTitleLabel)
        completeTitleLabel.mas_makeConstraints { (make) -> Void in
            make.left.equalTo()(describeTitleLabel)
            make.top.equalTo()(deadlineTitleLabel.mas_bottom).with().offset()(18)
        }
        
        _completeLabel.font = cellTextFont
        _completeLabel.textColor = cellContentColor
        bubbleImageView.addSubview(_completeLabel)
        _completeLabel.mas_makeConstraints { (make) -> Void in
            make.left.equalTo()(completeTitleLabel.mas_right).with().offset()(10)
            make.centerY.equalTo()(completeTitleLabel)
        }
    }
}
